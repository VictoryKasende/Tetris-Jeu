...
public class Mino {
    ...
    public void update() {
        ...
        // Move the mino
        if (Client.messageLue != null) {
            if (KeyHandler_1.upPressed || Client.messageLue.equals("rotation")) {
        ...
        if (Client.messageLue != null) {
            ...
            if (KeyHandler_1.downPressed || Client.messageLue.equals("down") ){
        ...
        if (Client.messageLue != null) {
            if (KeyHandler_1.leftPressed || Client.messageLue.equals("left")) {
        ...
        if (Client.messageLue != null){
            if (KeyHandler_1.rightPressed || Client.messageLue.equals("right")) {

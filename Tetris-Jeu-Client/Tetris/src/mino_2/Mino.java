...
import main.KeyHandler_2;
import main.PlayManager_2;
...
public class Mino {
    ...
    public void update(){
        ...
        if (KeyHandler_2.upPressed){
            ...
            KeyHandler_2.upPressed = false;
        }
        checkMovementCollision();
        if (KeyHandler_2.downPressed){
            dowm = !dowm;
            ...
            KeyHandler_2.downPressed = false;
        }
        if (KeyHandler_2.leftPressed){
            left = !left;
            ...
            KeyHandler_2.leftPressed = false;
        }
        if (KeyHandler_2.rightPressed){
            ...
            KeyHandler_2.rightPressed = false;
        ...
        if (bottomCollision){
            ...
            autoDropCounter++;
            if (autoDropCounter == PlayManager_2.dropInterval) {
                b[0].y += Block.SIZE;
                b[1].y += Block.SIZE;
                b[2].y += Block.SIZE;
                b[3].y += Block.SIZE;
